...
Target: 5 Unanimous Pan-Fibrotic Consensus Hub Genes (COL15A1, COL1A1, COL3A1, SERPINE2, SERPINF2)
...
out_csv = "results/hub_genes_hpa_ihc_validation_5genes.csv"
pd.DataFrame(records).to_csv(out_csv, index=False)
print(f"Saved data table: {out_csv}")

# Create Dual-Panel Figure
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(18, 7.2), sharey=True, dpi=300)
...
fig.suptitle(
    "Multi-Organ Molecular Characterization of 5 Unanimous Pan-Fibrotic Consensus Hub Genes\n"
