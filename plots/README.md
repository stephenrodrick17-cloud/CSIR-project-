...
| `severity_validation4_layer_boxplots.png` | Comprehensive $5 \times 3$ grid (15 panels) of clinical severity stage boxplots and regressions across independent cohorts for all 5 priority genes (`COL15A1`, `COL1A1`, `SERPINE2`, `SERPINF2`, `TNXB`). | `generate_layer4_comprehensive_plots.py` |
