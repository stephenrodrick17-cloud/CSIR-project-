...
| **Liver** | `GSE164760`, `GSE89377` | `GSE162694` | `GSE14323` |
...
To eliminate data leakage, all Validation 1 (`GSE58095`, `GSE200818`, `GSE162694`, `GSE24206`) and Validation 2 samples were excluded from ML training. The training matrix pools $N=1,069$ genuine human tissue samples across 9 Discovery series matrices:
