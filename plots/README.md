...
| **5. In Silico HPA IHC Validation** | `hub_genes_hpa_ihc_summary_5genes.png`<br>`results/hub_genes_hpa_ihc_validation_5genes.csv` | `hub_genes_hpa_ihc_summary_9genes.png`<br>`results/hub_genes_hpa_ihc_validation_9genes.csv` | **5-Gene**: Pathology staining across 4 human organs (Kidney, Liver, Lung, Skin) showing baseline vs. fibrotic upregulation & hepatic secretory repression for the 5 unanimous hubs.<br>**9-Gene**: Pathology staining across 4 human organs for all 9 consensus hubs using verified monospecific antibodies. |
